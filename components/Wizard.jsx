    ...
    switch (step) {
            ...
            return (
                <div className="space-y-6 animate-in fade-in duration-500">
                    <div className="border-b pb-4">
                        <h2 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Step 1: Consumption</h2>
        ...
        case 2:
            return (
                <div className="space-y-6 animate-in fade-in duration-500">
                    <div className="border-b pb-4">
                        <h2 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Step 2: Metrics</h2>
        ...
        case 3:
            return (
                <div className="space-y-8 animate-in fade-in duration-500">
                    <div className="border-b pb-4">
                        <h2 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Step 3: Dimensions</h2>
        ...
        case 4:
            return (
                <div className="space-y-6 animate-in fade-in duration-500">
                    <div className="border-b pb-4">
                        <h2 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Step 4: SLA & Impact</h2>
        ...
        case 5:
            return (
                <div className="space-y-6 animate-in fade-in duration-500">
                    <div className="border-b pb-4">
                        <h2 className="text-2xl font-black text-slate-800 uppercase tracking-tight">Step 5: Source Systems</h2>
